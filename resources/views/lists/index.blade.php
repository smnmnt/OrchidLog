    ...
    <ul class="list-group">
        @isset($flowers)
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="{{ route('flowers.index') }}" class="adding-list-link">Растения</a>
        ...
        @endisset
            ...
            @isset($top)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="{{ route('top.index') }}" class="adding-list-link">Типы посадки</a>
                    <span class="badge bg-primary rounded-pill">{{sizeof($top)}}</span>
                </li>
            @endisset
            @isset($tow)
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    <a href="{{ route('tow.index') }}" class="adding-list-link">Типы обработки</a>
