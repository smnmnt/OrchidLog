<p class="h5 mt-2">Недуги</p>
<li class="list-group-item mb-5"><a href="{{route('flowers.diseases.create', ['id' => $Unit->ID]) }}" class="link-primary">Добавить</a></li>
@if(isset($diseases) && sizeof($diseases))
    <table class="table table-striped table-bordered text-center align-middle">
        <thead>
        <tr>
            <th scope="col">#</th>
            <th scope="col" class="table_blooms_40pr">Наименование</th>
            <th scope="col"></th>
        </tr>
        </thead>
        <tbody>
